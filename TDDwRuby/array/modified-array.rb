...
RSpec.describe MyEnumerable do
  describe "my_each" do
    it "should go through each element and performs the block of code" do
      arr = [12, 24, 8, 9]
      output = []
  ...
  #   it "should return new array that meets condition" do
  #     arr = [12, 24, 8, 9]
  ...
  #   it "should return new array that didn't meet specified condition" do
  #     arr = [12, 24, 8, 9]
  ...
  # end
  # describe "my_map" do
  #   it "should return new array with each element modified by block" do
  #     arr = [1, 2, 3]
